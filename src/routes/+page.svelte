...
<div class="flex flex-col items-center justify-center gap-4 p-4">
	...
	>
		<Textarea placeholder="Nachricht eingeben..." bind:value={qVal} data-sveltekit-keepfocus />
	...
	<!-- {:else} -->
	<p>
		Der Chatbot ist momentan nur im Uni-Netz der Universität Bern erreichbar. Bitte loggen sie sich
		via VPN ins Uni-Netz ein und laden Sie die Seite erneut.
	</p>
	<!-- {/if} -->
</div>
